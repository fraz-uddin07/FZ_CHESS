...
public:
   ...
   // void renderBoard (const char board[8][8], SDL_Renderer* renderer);
   ...
   void renderBoard(const char board[8][8]);

   void appendToNextMessage( string msg );

   void renderCellHighlighter(SDL_Rect cellToHighlight);

   void undoHighlighter(SDL_Rect cellToUndoHighlight, const char board[8][8]);

   void checkPieceMovement(SDL_Rect pieceRect, int toXcor, int toYcor);
   ...
   bool isKingBeaten(const char currentBoard[8][8]);
...
private:
   ...
   SDL_Texture* whiteRookTex = nullptr;
   SDL_Texture* whiteKnightTex = nullptr;
   SDL_Texture* whiteBishopTex = nullptr;
   SDL_Texture* whiteQueenTex = nullptr;
   SDL_Texture* whiteKingTex = nullptr;
   SDL_Texture* whitePawnTex = nullptr;
   SDL_Texture* blackRookTex = nullptr;
   SDL_Texture* blackKnightTex = nullptr;
   SDL_Texture* blackBishopTex = nullptr;
   SDL_Texture* blackQueenTex = nullptr;
   SDL_Texture* blackKingTex = nullptr;
   SDL_Texture* blackPawnTex = nullptr;
